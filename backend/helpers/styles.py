...
class ALlStyles:
    ...
    font_lib = {
        "title_font": style_info.StyleInfo(
        ...
        "heading_name_font": style_info.StyleInfo(
            font_attributes=style_info.FontAttributes(
                name="name_font",
                font_name="Helvetica-Bold",
                font_size=16,
        ...
        "heading_desc_font": style_info.StyleInfo(
            font_attributes=style_info.FontAttributes(
    ...
    section_att_lib_0 = {
        ...
        3: style_info.StyleInfo(
            section_attributes=default_section_style_0, subStyleInfo=font_lib
        ),
        4: style_info.StyleInfo(
            section_attributes=default_section_style_0, subStyleInfo=font_lib
        ),
    }
